...
//
// ASCOM SafetyMonitor hardware class for TriStarObservatoryTSOSM
//
// Description:	 ASCOM SafetyMonitor Driver for TriStar Observatory
//
// Implements:	ASCOM SafetyMonitor interface version: ISafetyMonitor Interface
    ...
    internal static class SafetyMonitorHardware
    {
        ...
        static SafetyMonitorHardware()
        {
            try
            {
                ...
                tl = new TraceLogger("", "TriStarObservatoryTSOSM.Hardware");
        ...
        internal static void InitialiseHardware()
        {
            ...
            if (runOnce == false)
            {
                ...
                SafetyTimer = new System.Timers.Timer();
        ...
        public static string Name
        {
            get
            {
                string name = "TriStar Observatory Safety Monitor";
