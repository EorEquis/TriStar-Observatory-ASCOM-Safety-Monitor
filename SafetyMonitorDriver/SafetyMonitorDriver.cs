...
//
// ASCOM SafetyMonitor driver for TriStarObservatoryTSOSM
//
...
namespace ASCOM.TriStarObservatoryTSOSM.SafetyMonitor
{
    ...
    //
    // Your driver's DeviceID is ASCOM.TriStarObservatoryTSOSM.SafetyMonitor
    //
    // The COM Guid attribute sets the CLSID for ASCOM.TriStarObservatoryTSOSM.SafetyMonitor
    // The COM ClassInterface/None attribute prevents an empty interface called _TriStarObservatoryTSOSM from being created and used as the [default] interface
    //
    ...
    [ProgId("ASCOM.TSO.SafetyMonitor")]
    [ServedClassName("TriStar Observatory SafetyMonitor Driver")] // Driver description that appears in the Chooser, customise as required
    ...
    public class SafetyMonitor : ReferenceCountedObjectBase, ISafetyMonitor, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TriStarObservatoryTSOSM"/> class. Must be public to successfully register for COM.
        /// </summary>
        public SafetyMonitor()
        {
            try
            {
                ...
                tl = new TraceLogger("", "TriStarObservatoryTSOSM.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.TriStarObservatoryTSOSM.SafetyMonitor", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void SetTraceState()
        {
            using (Profile driverProfile = new Profile())
            {
                ...
                tl.Enabled = Convert.ToBoolean(driverProfile.GetValue(DriverProgId, SafetyMonitorHardware.traceStateProfileName, string.Empty, SafetyMonitorHardware.traceStateDefault));
            }
        }
