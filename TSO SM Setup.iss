...
;
[Setup]
AppID={{4fcf0306-f5bb-45b5-8fa5-f042975c8dc1}
AppName=TriStar Observatory ASCOM Safety Monitor Driver
AppVerName=TriStar Observatory ASCOM Safety Monitor Driver 2.0.2.2
AppVersion=2.0.2.2
...
OutputDir="."
OutputBaseFilename="TriStar_Observatory_SafetyMonitor_ASCOM_Setup-2.0.2.2"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\SafetyMonitor\TSO"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\SafetyMonitor\TSO"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "G:\Dev\Git\TriStar Observatory ASCOM Safety Monitor\bin\Release\ASCOM.TriStarObservatoryTSOSM.exe"; DestDir: "{app}"
; TODO: Add driver assemblies into the ServedClasses folder
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "G:\Dev\Git\TriStar Observatory ASCOM Safety Monitor\README.txt"; DestDir: "{app}"; Flags: isreadme
; TODO: Add other files needed by your driver here (add subfolders above)
Source: "G:\Dev\Git\TriStar Observatory ASCOM Safety Monitor\bin\Release\Newtonsoft.Json.dll"; DestDir: "{app}"
Source: "G:\Dev\Git\TriStar Observatory ASCOM Safety Monitor\bin\Release\Newtonsoft.Json.xml"; DestDir: "{app}"

; Only if driver is .NET
[Run]

; Only for .NET local-server drivers
Filename: "{app}\ASCOM.TriStarObservatoryTSOSM.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.TriStarObservatoryTSOSM.exe"; Parameters: "/unregister"
